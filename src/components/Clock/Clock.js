...
class Clock extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="card shadow clock-container styling">
        <div id="clock" className="clock-content">
          ...
          <div
            id="hours-indicator"
            className={
              "indicator hours-indicator shadow" +
          ...
          <div
            ...
            className={
              "indicator minutes-indicator shadow" +
          ...
          <div
            ...
            className={
              "indicator seconds-indicator shadow" +
              (this.state.date.getSeconds() === 0 ? "" : "transition-effect")
            }
            style={divStyleSeconds}
          ></div>
          <div className="indicator-cover shadow"></div>
        </div>
